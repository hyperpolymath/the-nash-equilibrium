...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/the-nash-equilibrium/security/advisories/new)
...
- This repository (`hyperpolymath/the-nash-equilibrium`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/the-nash-equilibrium/security/advisories)
...
When using The Nash Equilibrium, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/the-nash-equilibrium/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/the-nash-equilibrium/security/advisories/new) or j.d.a.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/the-nash-equilibrium/discussions) |
...
*Thank you for helping keep The Nash Equilibrium and its users safe.* 🛡️
