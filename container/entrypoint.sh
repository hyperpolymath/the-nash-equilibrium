...
cleanup() {
    echo "Received shutdown signal — stopping the-nash-equilibrium..."
...
echo "Starting the-nash-equilibrium..."
echo "  Host: ${APP_HOST:-[::]}"
...
# Examples:
#   exec /app/the-nash-equilibrium
#   exec /app/release/bin/the-nash-equilibrium start
#   exec /app/the-nash-equilibrium serve --host "${APP_HOST}" --port "${APP_PORT}"
