...
= Threat Model: The Nash Equilibrium
...
Brief description of The Nash Equilibrium and its architecture.

> See xref:../STATE-VISUALIZER.adoc[STATE-VISUALIZER.adoc] for the full architecture diagram and completion dashboard.
